...
if (!$id_usuario) {
    setAlert('error', 'Error', 'ID de usuario no válido');
...
if (!$usuario) {
    setAlert('error', 'Error', 'Usuario no encontrado');
    header('Location: index.php');
    exit();
}
        ...
        <div class="col-md-8">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1>
                    ...
                    Editar Usuario #<?php echo $id_usuario; ?>
                </h1>
                <a href="ver.php?id=<?php echo $id_usuario; ?>" class="btn btn-secondary">
                    <i class="fas fa-arrow-left"></i> Volver
                </a>
            </div>
                    ...
                    <form id="formUsuario" action="procesar.php" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="rol" id="rol" class="form-select" required>
                                    <option value="">Seleccione un rol</option>
                                    <option value="barbero" <?php echo $usuario['rol'] == 'barbero' ? 'selected' : ''; ?>>Barbero</option>
                                    <option value="apoyo" <?php echo $usuario['rol'] == 'apoyo' ? 'selected' : ''; ?>>Apoyo</option>
                        ...
                        <!-- Descripción del Rol Seleccionado -->
                        <div id="rolDescripcion" class="alert alert-info">
                            <h6 id="rolTitulo"></h6>
                            <ul id="rolPermisos" class="mb-0 small"></ul>
                        </div>
                        ...
                        <!-- Botones -->
                        <div class="text-end mt-4">
                            <a href="ver.php?id=<?php echo $id_usuario; ?>" class="btn btn-secondary me-2">
                                <i class="fas fa-times"></i> Cancelar
                            </a>
...
$(document).ready(function() {
    ...
    window.togglePassword = function(fieldId) {
        const field = document.getElementById(fieldId);
        const icon = event.currentTarget.querySelector('i');or complete correctamente todos los campos obligatorios',
